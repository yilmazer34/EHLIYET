...
class trafikAdabiVC: UIViewController, UITableViewDataSource, UITableViewDelegate {
    
    @IBOutlet weak var trafikAdabi: UITableView!
    ...
    private func setupDiagnostics() {
        ...
        diagnosticArray.append(Diagnostic(title: "4 Ağustos 2018 Trafik Adabı",image:check1, correct:String(correctAgustos18), incorrect:String(incorrectAgustos18),cozum:String(cozAgustos18), puan: String(puanAgustos18),basariOrani:boTAgustos18, basariProgres:boAgustos18 ))
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "Cell") as? trafikAdabiVCell else {
